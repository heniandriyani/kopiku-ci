...
<header class="container pt-5">
      <h1 id="hero-tagline" class="mb-5 fw-bolder text-uppercase text-center">Boost your day with <br> a cup of coffee</h1>
      ...
      <div class="container py-4">
        <div class="row">
          <div class="col-6 d-flex justify-content-center">
            <img id="about-img" height="600px" src="#" alt="">
          </div>
          <div class="col-6 col-6 d-flex justify-content-center align-items-center">
            <div>
            <div id="about-description"></div>
  
            <button id="about-button" class="btn btn-primary rounded-0 mt-3" type="button">READ MORE</button>
            </div>
          </div>
        </div>
      </div>
...
<section style="background-color:#F3F4F6; background-image:url(<?php echo base_url('resources/img/bg-footer.png')?>); background-position: bottom center; background-repeat: no-repeat">
    ...
    <script src="<?php base_url()?>resources/bootstrap/js/bootstrap.bundle.min.js"></script>
  ...
  <script>
    ...
    <script>
      $.get("http://localhost:1337/api/galleries?populate=*&&pagination[limit]=3", function(data, status){
      console.log(data)
      let dataHtml='';
      data.data.map((e)=>{
        dataHtml += `
...
$("#footer_tagline").text(data.data.attributes.footer_tagline)
$("#footer_image").text(data.data.attributes.footer_image)
$("#copyright").text(data.data.attributes.copyright)
$("#whatshapp_link").text(data.data.attributes.whatshapp_link)
$("#facebook_link").text(data.data.attributes.facebook_link)
$("#instagram_link").text(data.data.attributes.instagram_link)
$("#twitter_link").text(data.data.attributes.twitter_link)

let dataMenu = '';

data.data.attributes.page_menu.map((e)=>{
    dataMenu += `<a class="nav-link">${e.menu}</a>`
  })
